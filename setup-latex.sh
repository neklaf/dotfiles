...
if [ "$1" == "-i" ]; then
    ...
    check_and_install_packages texlive-base texlive-binaries texlive-latex-base texlive-fonts-extra latex-xft-fonts texlive-latex-extra texlive-latex-extra texlive-lang-spanish texlive-lang-english
